...
export function LiveMonitor({
  ...
  return (
    <div className="page-grid page-grid--live-cols">
      <div className="live-column-left">
        <section className="panel panel--wide">
          ...
          <div className="live-layout">
            ...
            <div className="risk-summary">
              <ScoreGauge score={latest.RiskScore} label="Overall Risk Score" />
        ...
        <section className="panel">
          ...
          <div className="stat-list stat-list--compact">
            ...
            <div>
              <span>Camera Sensor Status</span>
              <Pill
      ...
      <div className="live-column-right">
        <section className="panel">
          <div className="section-header">
            <div>
